...
/**
 * 본 클래스는 Byte 데이터 조작에 도움을 주는  유틸 클래스이다. 모든 프로젝트에서 사용할 유틸성 메소드를 구현할 경우에는 이곳에서 추가한다.
 * 
 ...
 */
@Slf4j
public class UtilByte extends kr.co.pionnet.butterfly2.core.util.UtilByte {
